...
class SearchResultAdapter(private val context: Context, private val imageModelArrayList: ArrayList<Product>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SearchResultAdapter.MyViewHolder {
        ...
        val view = inflater.inflate(R.layout.search_result_layout, parent, false)
