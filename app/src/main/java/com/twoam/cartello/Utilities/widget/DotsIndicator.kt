...
class DotsIndicator : LinearLayout {
    ...
    private fun setUpOnPageChangedListener() {
        pageChangedListener = object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                //                ImageView dot = dots.get(position);
                //                for (int i = 0; i < dots.size() ; i++) {
                //                    Log.d("Test", "onPageScrolled: " + position + ", " + i);
                //                    if (i == position)
                //                        dot.setBackgroundColor(getResources().getColor(R.color.colorAccent));
                //                    else dot.setBackgroundColor(getResources().getColor(R.color.black));
                //                }
            }
    ...
    companion object {
        ...
        private val DEFAULT_POINT_COLOR = Color.CYAN
        val DEFAULT_WIDTH_FACTOR = 2.5f
    }
}
